...
| AC06 | Usabilidad          | El sistema debe ofrecer una interfaz clara y fácil de usar para que distintos perfiles de usuario puedan completar sus tareas sin dificultades.    |
| AC07 | Interoperabilidad   | El sistema debe poder integrarse correctamente con sistemas externos como pasarela de pago, ERP, servicio de envío y facturación.                  |
