...
Las historias de usuario describen las principales necesidades desde la perspectiva de quien utilizará el sistema, siguiendo el formato:
...
| HU07 | Como cliente, quiero registrarme e iniciar sesión en el marketplace, para acceder a mis funcionalidades personalizadas.           |
| HU08 | Como seller, quiero consultar el estado y detalle de los pedidos que incluyen mis productos, para gestionar el despacho.          |
| HU09 | Como administrador, quiero consultar y gestionar los pedidos de la plataforma, para supervisar el funcionamiento del marketplace. |
| HU10 | Como cliente, quiero consultar comprobantes de pago de mis pedidos, para respaldar mis compras.                                   |
